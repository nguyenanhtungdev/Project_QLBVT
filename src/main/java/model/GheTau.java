...
public class GheTau {
	...
	public GheTau(String maGheTau, String tenLoaiGheTau, int soThuTuToa, String trangThai, ToaTau toaTau) {
		super();
	...
	public void setTrangThai(String trangThai) {
		if (trangThai.equals("Đang sử dụng") || trangThai.equals("Trống") || trangThai.equals("Bảo trì")
				|| trangThai.equals("Không còn sử dụng")) {
			this.trangThai = trangThai;
		} else {
	...
	public String toString() {
		return "GheTau{" + "maGheTau='" + maGheTau + '\'' + ", tenLoaiGheTau='" + tenLoaiGheTau + '\'' + ", soThuTuToa="
				+ soThuTuToa + ", trangThai='" + trangThai + '\'' + '}';
	}
}